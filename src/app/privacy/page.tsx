  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        ...
        <p className="text-muted-foreground mb-8">Last updated: August 22, 2025</p>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p className="mb-8">
            We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the <a href="https://www.privacypolicies.com/privacy-policy-generator/" className="text-blue-600 hover:underline">Privacy Policy Generator</a>.
          </p>
          ...
          <ul className="list-disc pl-6 mb-6 space-y-2">
            ...
            <li><strong>Application</strong> refers to Xplit, the software program provided by the Company.</li>
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Papineni Labs LLC, 840 Silver Buck Ln, Chesterfield, MO 63005.</li>
            ...
            <li><strong>Website</strong> refers to Papineni Labs, accessible from <a href="https://www.papinenilabs.com" className="text-blue-600 hover:underline">https://www.papinenilabs.com</a></li>
          ...
          <ul className="list-disc pl-6 mb-6">
            <li>By email: <a href="mailto:help@papinenilabs.com" className="text-blue-600 hover:underline">help@papinenilabs.com</a></li>
          </ul>
        </div>
      </div>
    </div>
